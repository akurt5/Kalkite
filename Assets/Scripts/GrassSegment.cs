...
public class GrassSegment : MonoBehaviour 
{
    ...
    public void CreateGrassSegment(float _Width, float _Height)
    {
        CreateGrassSegment(new Vector2(_Width, _Height));
    }
    public void CreateGrassSegment(Vector2 _Dimensions)
    {
    ...
    float colVal = Random.value;
        Color col = new Color(colVal, 0.85f, colVal, 1);
